    ...
    for layer in vertices_layers:
        ...
        for vertex_id in layer:
            if "ChatInput" in vertex_id:
                ...
                non_chat_input_vertices.append(vertex_id)

        if non_chat_input_vertices:
            remaining_layers.append(non_chat_input_vertices)

    if not chat_inputs_first:
        return vertices_layers

    return [chat_inputs_first, *remaining_layers]
